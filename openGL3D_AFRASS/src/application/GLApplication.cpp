...
void GLApplication::initialize() {
  ...
  //Activation de l'éliminations des parties cachées par depth buffer.
...
void GLApplication::draw() {
  ...
  // affecte tous les pixels du color buffer et du depth buffer avec les valeurs d'initialisation
